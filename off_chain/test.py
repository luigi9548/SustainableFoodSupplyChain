...
def test_successful_registration(cli):
    with patch('builtins.input', side_effect=[
        'Y',                                                                 # Deployment confirmation
        '0x8e97c482A802685d13fd9cCabc5E7ef793e3e243',                        # Public key input
        'username',                                                          # Username input
        'F', 'Y',                                                            # Role = Farmer and confirm
        'Password123!', 'Password123!',                                      # Password and confirmation
        '0xced0d12e23fe33b861a6c07e052a4dcf03424d62794c06127d575b935bb5b9db', 
        '0xced0d12e23fe33b861a6c07e052a4dcf03424d62794c06127d575b935bb5b9db' # Private key and confirmation
    ]), patch('maskpass.askpass', side_effect=[
        '0xced0d12e23fe33b861a6c07e052a4dcf03424d62794c06127d575b935bb5b9db', 
        '0xced0d12e23fe33b861a6c07e052a4dcf03424d62794c06127d575b935bb5b9db',# Private key e conferma
        ...
        mock_private_key.return_value.public_key.to_checksum_address.return_value = '0x8e97c482A802685d13fd9cCabc5E7ef793e3e243'
...
def test_common_menu_options_view_profile(cli):
    with patch('builtins.input', side_effect=[
        '1', '10', 'Y'  # View profile -> Logout -> Confirm logout
    ]), patch.object(cli.util, 'view_userView'), \
         patch.object(cli.session, 'reset_session'):
