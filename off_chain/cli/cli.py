    ...
    def insert_actor_info(self, username, role):
        ...
        while True:
          ...
          if self.controller.check_email_format(mail):
            if self.controller.check_unique_email(mail) == 0:
               ...
               break  
                ...
                print(Fore.RED + "This e-mail has already been inserted.\n" + Style.RESET_ALL)
          else:
           print(Fore.RED + "Invalid e-mail format.\n" + Style.RESET_ALL)
        while True:
        ...
        insert_code = self.controller.insert_actor_info(role, username, name, lastname, residence, birthdayPlace, birthday, mail, phone)
        if insert_code == 0:
